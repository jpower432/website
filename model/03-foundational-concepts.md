...
Other similar resources abound — such as the recent *Automated Governance Maturity Model* from the CNCF, which allows organizations to measure themselves and set growth goals for their GRC programs. Also, much work has been done in the standardization space by the US National Institute for Standards and Technology (NIST) on the [Open Security Controls Assessment Language](https://pages.nist.gov/OSCAL/) (OSCAL).
